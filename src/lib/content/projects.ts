  ...
  projects: [
    {
      ...
      repo: '',
      img: '/images/feasta-project.png',
      year: 2021,
      tags: ['Blade', 'Laravel', 'Google API'],
    },
    {
      id: getId(),
      name: 'Midhah Lyrics',
      url: 'https://lyrics.midhah.com/naat/ilm-aghaz-mein-sipara-e-quran',
      repo: '',
      img: '/images/middah-layrics-project.png',
      year: 2022,
      tags: ['React', 'Tailwind'],
    },
    {
    ...
    },
    {
      ...
      repo: '',
      img: '/images/primary-leap-project.png',
      year: 2022,
      tags: ['Laravel', 'BootStrap5', 'Html/CSS'],
    },
    {
      id: getId(),
      name: 'countries app',
